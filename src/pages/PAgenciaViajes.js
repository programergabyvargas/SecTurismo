                            ...
                            >
                              <div className="form-group">
                                <div className="atractivo-info">
                                  ...
                                  <hr />
                                  <h4>
                                    MARCELA MARTINUK – FRANQUICIA DE LOZADA
                                    VIAJES E.V.T. – Legajo N° 16026
                                  </h4>
                                  <span className="pr-4 ">
                                    <i className="fas fa-map-marker" />
                                  ...
                                  <span>
                                    <i class="fas fa-envelope" /> &nbsp;
                                    marcela.martinuk@lozadaviajes.com.ar
                                  </span>
                                  <br />
                                  <span>
                                    <i className="fas fa-clock" />
                                  ...
                                  <span className="pr-4">
                                    <i className="fas fa-user" />
                                    &nbsp; Tel./Cel.: 02657 – 43-5222
                                  </span>
                                  <br />
                                  <span>
                                    <i class="fas fa-envelope" /> &nbsp;
                                    peucayal@arlinkbbt.com.ar
                                  </span>
                                  <br />
                                  <span>
                                    <i className="fas fa-clock" />
